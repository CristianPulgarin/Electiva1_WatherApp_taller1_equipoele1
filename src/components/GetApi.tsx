  ...
  return (
    <>
      ...
      <div className="container_info">
        <h1 className="city">Ciudad: {weather.location}</h1>
        <img className="img_clima" src={clima} width={"100px"} />
        <br />
        <h1 className="humidity">Humedad: {weather.humidity}%</h1>
        <h1 className="temp">Temperatura: {weather.temperature}°</h1>
        <h1 className="clim">Clima: {weather.weather}</h1>
      </div>
    </>
  );
};
